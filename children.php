...
<body>
    <div class="container">
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>" . $row['Gender'] . "</td>
                                <td>
                                    <a href='edit-children.php?childID=" . $row['ChildID'] . "' class='button edit-button'>Edit</a>
                                    <a href='?deleteID=" . $row['ChildID'] . "' class='button delete-button' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                                </td>
                              </tr>";
                    }
                } else {
        ...
        <a href="add-children.php" class="add-button">
